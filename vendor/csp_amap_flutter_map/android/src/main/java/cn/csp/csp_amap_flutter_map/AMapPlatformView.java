...
import cn.csp.csp_amap_flutter_map.core.MapController;
import cn.csp.csp_amap_flutter_map.core.MapsInitializerController;
import cn.csp.csp_amap_flutter_map.overlays.marker.MarkersController;
import cn.csp.csp_amap_flutter_map.overlays.polygon.PolygonsController;
import cn.csp.csp_amap_flutter_map.overlays.polyline.PolylinesController;
...
public class AMapPlatformView
    ...
    AMapPlatformView(int id,
        ...
        methodChannel = new MethodChannel(binaryMessenger, "csp_amap_flutter_map_" + id);
